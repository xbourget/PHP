<?php
    ...
    // exercice 2 : - a/ faite le nécessaire pour qu'un véhicule ne puisse pas  
    //                dépasser sa vitesse max
    //              -b/  afficher un message lorsque la limite est atteinte
    //              -c/  lors de l'arrêt, indiquez la vitesse residuel
    //              -d/  si la vitesse résiduelle est supérieur à 10% de la vitesse max
